...
export const scienceMixin = {
  ...
  mounted() {
    ...
    apiGet(
      ...
      this.chartArr.sideItem2_3.title = `${aaa}年-${ccc}年${this.cityName}每万人发明专利授权量变化`
