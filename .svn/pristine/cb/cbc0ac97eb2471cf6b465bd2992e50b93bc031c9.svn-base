    ...
    <nav class="navTopArea">
      ...
      <ul class="navRight">
        <li :class="{navActive:routerActive === 1}" @click="routerFn(1)">
          <el-tooltip class="item" effect="dark" content="人口总量" placement="top">
            <div>
        ...
        <li :class="{navActive:routerActive === 2}" @click="routerFn(2)">
          <el-tooltip class="item" effect="dark" content="人口结构" placement="top">
            <div>
        ...
        <li :class="{navActive:routerActive === 3}" @click="routerFn(3)">
          <el-tooltip class="item" effect="dark" content="人口分布" placement="top">
            <div>
        ...
        <li :class="{navActive:routerActive === 4}" @click="routerFn(4)">
          <el-tooltip class="item" effect="dark" content="人口迁移" placement="top">
            <div>
        ...
        <li :class="{navActive:routerActive === 5}" @click="routerFn(5)">
          <el-tooltip class="item" effect="dark" content="人口联系" placement="top">
            <div>
    ...
    <div class="bottomMain">
          ...
          <h4 class="moudleTitle">
            ...
            <p class="optionGroup" style="justify-content: flex-end;">
              <img class="optionImg" src="@/assets/images/downImgIcon.png"
                @click="imagesLoadOpenFn('sideItem1_1',chartArr.sideItem1_1.title,createTimeMap)">
            </p>
          </h4>
        ...
        <div class="twoWrap">
          ...
          <div class="sideItem width910 sideItem2_8">
            <h4 class="moudleTitle">
              ...
              <p class="optionGroup">
                <img class="optionImg" @click="imagesLoadOpenFn('sideItem2_8',chartArr.sideItem2_8.title,barLineChart)"
                  src="@/assets/images/downImgIcon.png">
                <el-dropdown @command="chartTypeClick">
                  <span class="el-dropdown-link">
                    <img class="optionImg" src="@/assets/images/echartTypeIcon.png">
      ...
      <div class="mainWrap" v-show="routerActive === 3">
        ...
        <div class="sideItem width600 sideItem3_0">
          <h4 class="moudleTitle">
            ...
            <p class="optionGroup" style="justify-content: flex-end;">
              <img class="optionImg" src="@/assets/images/downImgIcon.png"
                @click="imagesLoadOpenFn('sideItem3_0',chartArr.sideItem3_0.title,createTimeMap)">
            </p>
          </h4>
        ...
        <div class="sideItem width600 sideItem3_1">
          <h4 class="moudleTitle">
            ...
            <p class="optionGroup" style="justify-content: flex-end;">
              <img class="optionImg" src="@/assets/images/downImgIcon.png"
                @click="imagesLoadOpenFn('sideItem3_1',chartArr.sideItem3_1.title,createTimeMap)">
            </p>
          </h4>
        ...
        <div class="sideItem width600 sideItem3_2">
          <h4 class="moudleTitle">
            ...
            <p class="optionGroup" style="justify-content: flex-end;">
              <img class="optionImg" src="@/assets/images/downImgIcon.png"
                @click="imagesLoadOpenFn('sideItem3_2',chartArr.sideItem3_2.title,createTimeMap)">
            </p>
          </h4>
        ...
        <div class="sideItem width600 sideItem3_3">
          <h4 class="moudleTitle">
            ...
            <p class="optionGroup" style="justify-content: flex-end;">
              <img class="optionImg" src="@/assets/images/downImgIcon.png"
                @click="imagesLoadOpenFn('sideItem3_3',chartArr.sideItem3_3.title,createTimeMap)">
            </p>
          </h4>
        ...
        <div class="sideItem width600 sideItem3_4">
          <h4 class="moudleTitle">
            ...
            <p class="optionGroup" style="justify-content: flex-end;">
              <img class="optionImg" src="@/assets/images/downImgIcon.png"
                @click="imagesLoadOpenFn('sideItem3_4',chartArr.sideItem3_4.title,createTimeMap)">
            </p>
          </h4>
      ...
      <div class="mainWrap" v-show="routerActive === 4">
        ...
        <div class="sideItem width910 sideItem4_0">
          ...
          <el-tooltip class="item" effect="dark" placement="top">
            <div slot="content">净流入或净流出由当年常住人口增量减去自然增长人数获得，值为正数为“净流入”，负数为“净流出”。</div>
        ...
        <div class="twoWrap">
          <div class="sideItem width910 sideItem4_2">
            <h4 class="moudleTitle">
              ...
              <p class="optionGroup">
                <img class="optionImg" @click="imagesLoadOpenFn('sideItem4_2',chartArr.sideItem4_2.title,barLineChart)"
                  src="@/assets/images/downImgIcon.png">
                <el-dropdown @command="chartTypeClick">
                  <span class="el-dropdown-link">
                    <img class="optionImg" src="@/assets/images/echartTypeIcon.png">
          ...
          <div class="sideItem width910 sideItem4_3">
            <h4 class="moudleTitle">
              ...
              <p class="optionGroup">
                <img class="optionImg" @click="imagesLoadOpenFn('sideItem4_3',chartArr.sideItem4_3.title,barLineChart)"
                  src="@/assets/images/downImgIcon.png">
                <el-dropdown @command="chartTypeClick">
                  <span class="el-dropdown-link">
                    <img class="optionImg" src="@/assets/images/echartTypeIcon.png">
...
import { peopleCountMixin } from '@/utils/cityPeopleAnalyze/peopleCount.js'
import { structuraMixin } from '@/utils/cityPeopleAnalyze/structura.js'
import { migrationMixin } from '@/utils/cityPeopleAnalyze/migration.js'
import { distributionMixin } from '@/utils/cityPeopleAnalyze/distribution.js'
import { contactMixin } from '@/utils/cityPeopleAnalyze/contact.js'
