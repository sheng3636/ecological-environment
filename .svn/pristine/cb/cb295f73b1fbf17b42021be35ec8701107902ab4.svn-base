...
export const emissionsMixin = {
  ...
  mounted() {
    ...
    getStructuralData({
      ...
      let data = res.data[0]
      this.chartArr.sideItem3_0.title = `${this.returnArrFirst(data.xAxis)}年-${this.returnArrLast(data.xAxis)}年${this.countyName}化学需氧量排放总量变化`
    ...
    getScaleData({
      ...
      let data = res.data
      this.chartArr.sideItem3_1.title = `${data.yAxis.year}年${this.cityName}各区县（市）化学需氧量排放总量`
    ...
    getScaleDataWithName({
      ...
      this.chartArr.sideItem3_2.title = `${data.year}年${this.cityName}各区县（市）化学需氧量排放总量占比`
    ...
    getStrength({
      ...
      let data = res.data
      this.chartArr.sideItem3_3.title = `${data.yAxis.year}年${this.cityName}各区县（市）化学需氧量排放强度`
    ...
    getStructuralData({
      ...
      let data = res.data[0]
      this.chartArr.sideItem3_4.title = `${this.returnArrFirst(data.xAxis)}年-${this.returnArrLast(data.xAxis)}年${this.countyName}氨氮排放总量变化`
    ...
    getScaleData({
      ...
      let data = res.data
      this.chartArr.sideItem3_5.title = `${data.yAxis.year}年${this.cityName}各区县（市）氨氮排放总量`
    ...
    getScaleDataWithName({
      ...
      this.chartArr.sideItem3_6.title = `${data.year}年${this.cityName}各区县（市）氨氮排放总量占比`
    ...
    getStrength({
      ...
      let data = res.data
      this.chartArr.sideItem3_7.title = `${data.yAxis.year}年${this.cityName}各区县（市）氨氮排放强度`
    ...
    getStructuralData({
      ...
      let data = res.data[0]
      this.chartArr.sideItem3_8.title = `${this.returnArrFirst(data.xAxis)}年-${this.returnArrLast(data.xAxis)}年${this.countyName}二氧化硫排放总量变化`
    ...
    getScaleData({
      ...
      let data = res.data
      this.chartArr.sideItem3_9.title = `${data.yAxis.year}年${this.cityName}各区县（市）二氧化硫排放总量`
    ...
    getScaleDataWithName({
      ...
      this.chartArr.sideItem3_10.title = `${data.year}年${this.cityName}各区县（市）二氧化硫排放总量占比`
    ...
    getStrength({
      ...
      let data = res.data
      this.chartArr.sideItem3_11.title = `${data.yAxis.year}年${this.cityName}各区县（市）二氧化硫排放强度`
    ...
    getStructuralData({
      ...
      let data = res.data[0]
      this.chartArr.sideItem3_12.title = `${this.returnArrFirst(data.xAxis)}年-${this.returnArrLast(data.xAxis)}年${this.countyName}氮氧化物排放总量变化`
      ...
      this.chartArr.sideItem3_12.unit = data.unit
    ...
    getScaleData({
      ...
      let data = res.data
      this.chartArr.sideItem3_13.title = `${data.yAxis.year}年${this.cityName}各区县（市）氮氧化物排放总量`
    ...
    getScaleDataWithName({
      ...
      this.chartArr.sideItem3_14.title = `${data.year}${this.cityName}各区县（市）氮氧化物排放总量占比`
    ...
    getStrength({
      ...
      let data = res.data
      this.chartArr.sideItem3_15.title = `${data.yAxis.year}年${this.cityName}各区县（市）氮氧化物排放强度`
