  ...
  <div class="bodyMain">
    <nav class="navTopArea">
      <div class="navLeft">
        ...
        <span v-show="routerActive === 1">{{this.$route.query.countyName}}三次产业结构分析</span>
        <span v-show="routerActive === 2">{{this.$route.query.countyName}}制造业结构分析</span>
        <span v-show="routerActive === 3">{{this.$route.query.countyName}}服务业结构分析</span>
      </div>
      <ul class="navRight">
    ...
    <div class="bottomMain">
      <div class="mainWrap" v-show="routerActive === 1">
        ...
        <div class="sideItem width910 sideItem1_2">
          ...
          <div class="sideItemChart width910" id="sideItem1_2">
        ...
        <div class="sideItem width910 sideItem1_3">
          ...
          <div class="sideItemChart width910" id="sideItem1_3">
            <span v-if="chartArr.sideItem1_2.isValue" class="noData">暂无数据</span>
          </div>
          <div class="resultWrap">
        ...
        <div class="CuttingLine">
          <p class="txtWrap">
            <img src="@/assets/images/cuttingLine1.png">
            <span class="txt">全省县区市GDP、二产增加值、三产增加值</span>
            <img src="@/assets/images/cuttingLine2.png">
          </p>
        </div>
        <div class="sideItem width1845 sideItem1_4">
          <h4 class="moudleTitle">
            ...
            <p class="optionGroup" style="width: 120px;">
              <img class="optionImg" src="@/assets/images/exportIcon.png"
                @click="exportExce(chartArr.sideItem1_4.title,['18年排名', '地区', '生产总值', '生产总值增速', '15年排名', '排名较15年变化'],['value18', 'area', 'value1', 'value15', 'num'],chartArr.sideItem1_4.list)">
              ...
              <el-dropdown @command="chartTypeClick">
                ...
                <el-dropdown-menu slot="dropdown">
                  ...
                  <el-dropdown-item :command="beforeHandleCommand('sideItem1_4',['line','line'],barLineChart)" divided>
                    <img class="chartIcon" src="@/assets/images/lineIcon.png">
                    <span class="txt">折线图样式</span>
                  </el-dropdown-item>
                </el-dropdown-menu>
          ...
          <div style="display:flex;">
            <div class="width1080">
              <div class="sideItemChart width1080" id="sideItem1_4">
            ...
            <div class="tableWrap width740">
              <el-table :data="chartArr.sideItem1_4.list" fit height="632">
                <el-table-column prop="value18" label="18年排名" align="center" />
                <el-table-column prop="area" label="地区" align="center" />
                <el-table-column prop="value1" label="生产总值" align="center" />
                <el-table-column prop="value2" label="生产总值增速" align="center" />
                <el-table-column prop="value15" label="15年排名" align="center" />
                <el-table-column prop="num" label="排名较15年变化" align="center">
                  <template slot-scope="scope">
                    <span v-if="scope.row.num > 0" style="color:#00f082">
                      {{Math.abs(scope.row.num)}}
                      <i class="el-icon-top"></i>
                    </span>
                    <span v-if="scope.row.num < 0" style="color:red">
                      {{Math.abs(scope.row.num)}}
        ...
        <div class="sideItem width1845 sideItem1_5">
          <h4 class="moudleTitle">
            ...
            <p class="optionGroup" style="width: 120px;">
              <img class="optionImg" src="@/assets/images/exportIcon.png"
                @click="exportExce(chartArr.sideItem1_5.title,['18年排名', '地区', '二产增加值', '二产增速', '15年排名', '排名较15年变化'],['value18', 'area', 'value1', 'value15', 'num'],chartArr.sideItem1_5.list)">
              ...
              <el-dropdown @command="chartTypeClick">
                ...
                <el-dropdown-menu slot="dropdown">
                  <el-dropdown-item :command="beforeHandleCommand('sideItem1_5',['bar','line'],barLineChart)">
          ...
          <div style="display:flex;">
            <div class="tableWrap width740">
              <el-table :data="chartArr.sideItem1_5.list" fit height="632">
                <el-table-column prop="value18" label="18年排名" align="center" />
                <el-table-column prop="area" label="地区" align="center" />
                <el-table-column prop="value1" label="二产增加值" align="center" />
                <el-table-column prop="value2" label="二产增速" align="center" />
                <el-table-column prop="value15" label="15年排名" align="center" />
                <el-table-column prop="num" label="排名较15年变化" align="center">
                  <template slot-scope="scope">
                    <span v-if="scope.row.num > 0" style="color:#00f082">
            ...
            <div class="width1080">
              <div class="sideItemChart width1080" id="sideItem1_5">
        ...
        <div class="sideItem width1845 sideItem1_6">
          <h4 class="moudleTitle">
            ...
            <p class="optionGroup" style="width: 120px;">
              <img class="optionImg" src="@/assets/images/exportIcon.png"
                @click="exportExce(chartArr.sideItem1_6.title,['18年排名', '地区', '三产增加值', '三产增速', '15年排名', '排名较15年变化'],['value18', 'area', 'value1', 'value15', 'num'],chartArr.sideItem1_6.list)">
          ...
          <div style="display:flex;">
            <div class="width1080">
              <div class="sideItemChart width1080" id="sideItem1_6">
            ...
            <div class="tableWrap width740">
              <el-table :data="chartArr.sideItem1_6.list" fit height="632">
                <el-table-column prop="value18" label="18年排名" align="center" />
                <el-table-column prop="area" label="地区" align="center" />
                <el-table-column prop="value1" label="三产增加值" align="center" />
                <el-table-column prop="value2" label="三产增速" align="center" />
                <el-table-column prop="value15" label="15年排名" align="center" />
                <el-table-column prop="num" label="排名较15年变化" align="center">
                  <template slot-scope="scope">
                    <span v-if="scope.row.num > 0" style="color:#00f082">
        ...
        <div class="sideItem width1845 sideItem1_7">
          <h4 class="moudleTitle">
            <span class="left">{{chartArr.sideItem1_7.title}}</span>
            <p class="optionGroup" style="justify-content: flex-end;">
              <img class="optionImg" @click="imagesLoadOpenFn('sideItem1_7',chartArr.sideItem1_7.title,scatterChart)"
                src="@/assets/images/downImgIcon.png">
            </p>
          </h4>
          <div class="sideItemChart width1845" id="sideItem1_7">
      ...
      <div class="mainWrap" v-show="routerActive === 2">
        ...
        <div class="twoWrap">
          ...
          <div class="rightResultWrap" style="height: 707px;">
            <span class="fourIcon" v-for="(item,index) in 4" :key="index" :class="'fourIcon' + index"></span>
        ...
        <div class="sideItem width1845 sideItem2_3">
          <h4 class="moudleTitle">
            ...
            <p class="optionGroup" style="justify-content: flex-end;">
              <img class="optionImg" src="@/assets/images/exportIcon.png"
                @click="exportExce(chartArr.sideItem2_3.title,['证券代码', '证券简称', '上市板', '公司中文名称', '主营产品类型'],['securitiesCode', 'securitiesName', 'shangshiBoard', 'companyName', 'productType'],chartArr.sideItem2_3.list)">
            </p>
          </h4>
          <div class="tableWrap">
            <el-table :data="chartArr.sideItem2_3.list" fit>
              <el-table-column type="index" width="55" label="序号" align="center" />
              <el-table-column prop="securitiesCode" label="证券代码" align="center" />
              <el-table-column prop="securitiesName" label="证券简称" align="center" />
              <el-table-column prop="shangshiBoard" label="上市板" align="center" />
              <el-table-column prop="companyName" label="公司中文名称" align="center" />
              <el-table-column prop="productType" label="主营产品类型" align="center" />
            </el-table>
          </div>
          <div class="resultWrap">
        ...
        <div class="sideItem width800 sideItem2_4">
          <h4 class="moudleTitle">
            <span class="left">{{chartArr.sideItem2_4.title}}</span>
            <p class="optionGroup">
              <img class="optionImg"
                @click="imagesLoadOpenFn('sideItem2_4',chartArr.sideItem2_4.title,textTopHorizontalChart)"
                src="@/assets/images/downImgIcon.png">
              <el-dropdown @command="chartTypeClick">
                <span class="el-dropdown-link">
                  <img class="optionImg" src="@/assets/images/echartTypeIcon.png">
                ...
                <el-dropdown-menu slot="dropdown">
                  <el-dropdown-item :command="beforeHandleCommand('sideItem2_4',['bar'],textTopHorizontalChart)">
                    <img class="chartIcon" src="@/assets/images/barLineIcon.png">
                    <span class="txt">柱状图样式</span>
                  </el-dropdown-item>
                  <el-dropdown-item :command="beforeHandleCommand('sideItem2_4',['line'],textTopHorizontalChart)"
                    divided>
                    <img class="chartIcon" src="@/assets/images/lineIcon.png">
                    <span class="txt">折线图样式</span>
                  </el-dropdown-item>
          ...
          <div class="sideItemChart width800" id="sideItem2_4">
        ...
        <div class="sideItem width1020 sideItem2_5">
          <h4 class="moudleTitle">
          ...
          <div class="sideItemChart width1020" id="sideItem2_5">
          ...
          <h4 class="moudleTitle">
            ...
            <p class="optionGroup">
              ...
              <el-dropdown @command="chartTypeClick">
                ...
                <el-dropdown-menu slot="dropdown">
                  <el-dropdown-item :command="beforeHandleCommand('sideItem3_0',['bar'],barLineChart)">
                    <img class="chartIcon" src="@/assets/images/barLineIcon.png">
                    <span class="txt">柱状图样式</span>
                  </el-dropdown-item>
                  <el-dropdown-item :command="beforeHandleCommand('sideItem3_0',['line'],barLineChart)" divided>
                    <img class="chartIcon" src="@/assets/images/lineIcon.png">
                    <span class="txt">折线图样式</span>
                  </el-dropdown-item>
                </el-dropdown-menu>
          ...
          <h4 class="moudleTitle">
            ...
            <p class="optionGroup">
              ...
              <el-dropdown @command="chartTypeClick">
                ...
                <el-dropdown-menu slot="dropdown">
                  <el-dropdown-item :command="beforeHandleCommand('sideItem3_1',['bar'],barLineChart)">
                    <img class="chartIcon" src="@/assets/images/barLineIcon.png">
                    <span class="txt">柱状图样式</span>
                  </el-dropdown-item>
                  <el-dropdown-item :command="beforeHandleCommand('sideItem3_1',['line'],barLineChart)" divided>
                    <img class="chartIcon" src="@/assets/images/lineIcon.png">
                    <span class="txt">折线图样式</span>
                  </el-dropdown-item>
                </el-dropdown-menu>
        ...
        <div class="twoWrap">
          ...
          <div class="sideItem width740 sideItem3_2">
            ...
            <div class="sideItemChart width740" id="sideItem3_2" style="height: calc(100% - 60px - 45px);"><span
                class="noData" v-if="chartArr.sideItem3_2.isValue">暂无数据</span></div>
          ...
          <div>
            <div class="sideItem width1080 sideItem3_3">
              ...
              <div class="sideItemChart width1080" id="sideItem3_3">
            ...
            <div class="sideItem width1080 sideItem3_4">
              ...
              <div class="sideItemChart width1080" id="sideItem3_4">
...
import { threeIndustrialMixin } from '@/utils/countyIndustrialDev/threeIndustrial.js'
import { manufacturingMixin } from '@/utils/countyIndustrialDev/manufacturing.js'
import { serviceIndustryMixin } from '@/utils/countyIndustrialDev/serviceIndustry.js'
...
@import './countyIndustrialDev.scss';
</style>
