  ...
  <div class="bodyMain">
    <nav class="navTopArea">
      <div class="navLeft">
        ...
        <span v-if="routerActive === 1">{{countyName}}环境质量分析</span>
        <span v-if="routerActive === 2">{{countyName}}生态资源分析</span>
        <span v-if="routerActive === 3">{{countyName}}污染物排放分析</span>
        <span v-if="routerActive === 4">{{countyName}}生态资源状况分析</span>
      </div>
      <ul class="navRight">
        ...
        <li @click="junpLink('http://118.190.204.249:8989/aiPage?tag=home&cityName=' + countyName)">
    ...
    <div class="bottomMain">
      <div class="mainWrap" v-show="routerActive === 1">
        ...
        <div class="sideItem width800 sideItem1_2">
          <h4 class="moudleTitle">
          ...
          <div class="sideItemChart width800" id="sideItem1_2"></div>
          <div class="resultWrap">
        ...
        <div class="sideItem width1020 sideItem1_3">
          <h4 class="moudleTitle">
          ...
          <div class="sideItemChart width1020" id="sideItem1_3"></div>
          <div class="resultWrap">
        ...
        <div class="twoWrap">
          <div class="sideItem width910 sideItem1_4">
            ...
            <h5 class="dataSourceTxt">数据来源：{{chartArr.sideItem1_4.dataSource}}</h5>
          </div>
          <div class="sideItem width910 sideItem1_5">
            <h4 class="moudleTitle">
              <p class="left">{{chartArr.sideItem1_5.title}}</p>
              <p class="optionGroup" style="justify-content: flex-end;">
                <img @click="exportType" class="optionImg" src="@/assets/images/exportIcon.png" v-if="chartArr.sideItem1_5.dataSource != '暂无数据'">
              </p>
            </h4>
            <ul class="sideItemChart width910 tableWrap">
              <li class="head">
                <p></p>
                <p v-for="(item,index) in chartArr.sideItem1_5.headData.slice(0,6)" :key="index">{{item}}</p>
              </li>
              <li class="body" v-for="(item1,k) in chartArr.sideItem1_5.bodyData" :key="k">
                <p>{{item1.name}}</p>
                <p class="yellow" v-for="(item2,j) in item1.list.slice(0,6)" :key="j">{{item2}}</p>
              </li>
            </ul>
            <h5 class="dataSourceTxt">数据来源：{{chartArr.sideItem1_5.dataSource}}</h5>
          </div>
      ...
      <div class="mainWrap" v-show="routerActive === 2">
        ...
        <div class="twoWrap">
          ...
          <div class="sideItem width910 sideItem2_1">
            <h4 class="moudleTitle">
              <span class="left">{{chartArr.sideItem2_1.title}}</span>
              <p class="optionGroup">
                <img class="optionImg"
                  @click="imagesModalOpenFn('sideItem2_1',chartArr.sideItem2_1.title,singleBarLineChart)"
                  src="@/assets/images/downImgIcon.png">
                <el-dropdown class="chartDropdown" trigger="click" @command="chartTypeClick">
                  <span class="el-dropdown-link">
                    <img class="optionImg" src="@/assets/images/echartTypeIcon.png">
                  ...
                  <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item :command="beforeHandleCommand('sideItem2_1','bar',singleBarLineChart)">
                      <img class="chartIcon" src="@/assets/images/barLineIcon.png">
                      <span class="txt">柱状图样式</span>
                    </el-dropdown-item>
                    <el-dropdown-item :command="beforeHandleCommand('sideItem2_1','line',singleBarLineChart)" divided>
                      <img class="chartIcon" src="@/assets/images/lineIcon.png">
                      <span class="txt">折线图样式</span>
                    </el-dropdown-item>
                  </el-dropdown-menu>
            ...
            <div class="sideItemChart width910" id="sideItem2_1"></div>
            <h5 class="dataSourceTxt">数据来源：{{chartArr.sideItem2_1.dataSource}}</h5>
          </div>
          <div class="resultWrap" style="width: 100%;">
            <div class="content">
      ...
      <div class="mainWrap" v-show="routerActive === 3">
        ...
        <div class="twoWrap">
          <div class="sideItem width800 sideItem3_4">
            <h4 class="moudleTitle">
            ...
            <div class="sideItemChart width800" id="sideItem3_4"></div>
            <h5 class="dataSourceTxt">数据来源：{{chartArr.sideItem3_4.dataSource}}</h5>
          </div>
          <div class="sideItem width1020 sideItem3_5">
            <h4 class="moudleTitle">
            ...
            <div class="sideItemChart width1020" id="sideItem3_5"></div>
        ...
        <div class="twoWrap">
          <div class="sideItem width800 sideItem3_8">
            <h4 class="moudleTitle">
            ...
            <div class="sideItemChart width800" id="sideItem3_8"></div>
            <h5 class="dataSourceTxt">数据来源：{{chartArr.sideItem3_8.dataSource}}</h5>
          </div>
          <div class="sideItem width1020 sideItem3_9">
            <h4 class="moudleTitle">
              <span class="left">{{chartArr.sideItem3_9.title}}</span>
              <p class="optionGroup">
                <img class="optionImg"
                  @click="imagesModalOpenFn('sideItem3_9',chartArr.sideItem3_9.title,singleBarLineChart)"
                  src="@/assets/images/downImgIcon.png">
                <el-dropdown class="chartDropdown" trigger="click" @command="chartTypeClick">
                  <span class="el-dropdown-link">
                    <img class="optionImg" src="@/assets/images/echartTypeIcon.png">
            ...
            <div class="sideItemChart width1020" id="sideItem3_9"></div>
        ...
        <div class="twoWrap">
          <div class="sideItem width800 sideItem3_12">
            <h4 class="moudleTitle">
            ...
            <div class="sideItemChart width800" id="sideItem3_12"></div>
            <h5 class="dataSourceTxt">数据来源：{{chartArr.sideItem3_12.dataSource}}</h5>
          </div>
          <div class="sideItem width1020 sideItem3_13">
            <h4 class="moudleTitle">
            ...
            <div class="sideItemChart width1020" id="sideItem3_13"></div>
      ...
      <div class="mainWrap" style="margin-top: 30px;" v-show="routerActive === 4">
        <div class="sideItem width1845 sideItem4_0">
          ...
          <h5 class="dataSourceTxt">数据来源：{{chartArr.sideItem4_0.dataSource}}</h5>
        </div>
        <div class="sideItem width1845 sideItem4_1">
          ...
          <div class="tableWrap tableWrap1">
            <el-table :data="chartArr.sideItem4_1.list" fit>
...
import { environmentalQualityMixin } from '@/utils/countyEnvironmental/qualityMixin.js'
import { ecologicaleResourcesMixin } from '@/utils/countyEnvironmental/ecologicaleResourcesMixin.js'
import { emissionsMixin } from '@/utils/countyEnvironmental/emissionsMixin.js'
import { environmentStateMixin } from '@/utils/countyEnvironmental/environmentStateMixin.js'
...
export default {
    ...
    return {
      ...
      baseUrl:
        process.env.NODE_ENV === 'production'
          ? 'http://47.103.102.173:8881/ecologicalMap/'
          : 'http://192.168.13.251:8083/', // 系统域名
      cityName: '', // 被分析城市
      countyName: '', // 被分析县区
  ...
  methods: {
    initQualityChart(color) {
      ...
      this.singleBarLineChart('sideItem2_1', this.chartArr.sideItem2_1)
        ...
        axios.all(picArrFn).then(
          axios.spread(() => {
            axios({
              ...
              let fileName = `${_self.countyName}生态环境分析报告${year}${month}${day}${hours}${minutes}${seconds}`
    ...
    pieChart(id, data) {
      ...
      chart.clear()
      chart.setOption(option)
      this.pieSelected(chart, data.list, this.countyName)
    },
    // 饼图选中指定扇形区域
...
@import './countyEnvironmental.scss';
</style>
