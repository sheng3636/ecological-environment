...
export const peopleCountMixin = {
  ...
  mounted() {
      ...
      getStructuralData1({
        ...
        this.chartArr.sideItem1_0.result = `${aaa}年末，${this.cityName}常住人口总量为<span class="light">${bbb}</span>，
      ...
      getScaleDataWithName1({
        ...
        this.chartArr.sideItem1_1.result = `${this.cityName}市常驻人口为<span class="light">${aaa.value}</span>万人`
        this.createTimeMap('sideItem1_1', this.chartArr.sideItem1_1.listObj)
      })
      // 2、获取某年某地区与全省常住人口人口比较数据并绘制图表
      getMultiZoneData({
        ...
        this.chartArr.sideItem1_2.title = `${ccc}年-${aaa}年${this.cityName}与全省常住人口人口比较`        
      })
      ...
      getMultiZoneData({
        ...
        this.chartArr.sideItem1_3.title = `${ccc}年-${aaa}年${this.cityName}与全省户籍人口人口规模比较`
